...
**docker-compose:**
- Pin image versions (`postgres:16`, not `postgres:latest`), matching whatever version this project already uses elsewhere (check existing Docker usage in this repo/`CLAUDE.md` before picking one).
